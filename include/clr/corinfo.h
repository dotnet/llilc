//===---- CorInfo.h - EE / Code generator interface  ----------*- C++ -*-===//
//
// ==++==
//
...
#if 0 // #ifdef _TARGET_ARM_              // NYI: NOGC_WRITE_BARRIERS JIT helper calls
                                   // Unchecked versions R1 is required to point into GC heap
    CORINFO_HELP_ASSIGN_REF_R0,    // R0 holds GC ptr, do a 'str  R0, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R2,    // R2 holds GC ptr, do a 'str  R2, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R3,    // R3 holds GC ptr, do a 'str  R3, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R4,    // R4 holds GC ptr, do a 'str  R4, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R5,    // R5 holds GC ptr, do a 'str  R5, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R6,    // R6 holds GC ptr, do a 'str  R6, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R7,    // R7 holds GC ptr, do a 'str  R7, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R8,    // R8 holds GC ptr, do a 'str  R8, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R9,    // R9 holds GC ptr, do a 'str  R9, [R1]' and inform GC
    CORINFO_HELP_ASSIGN_REF_R10,   // R10 holds GC ptr, do a 'str  R10, [R1]' and inform GC

    CORINFO_HELP_CHECKED_ASSIGN_REF_R0,  // These are the same as ASSIGN_REF above ...
    CORINFO_HELP_CHECKED_ASSIGN_REF_R2,  // ... but also check if R1 points into the GC heap.
    CORINFO_HELP_CHECKED_ASSIGN_REF_R3,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R4,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R5,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R6,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R7,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R8,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R9,
    CORINFO_HELP_CHECKED_ASSIGN_REF_R10,
#endif
