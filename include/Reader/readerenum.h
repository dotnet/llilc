...
SELECTANY const char OpcodeRemap[ReaderBaseNS::CEE_MACRO_END -
    ...
    ReaderBaseNS::Beq, ReaderBaseNS::Bge, ReaderBaseNS::Bgt, ReaderBaseNS::Ble,
    ReaderBaseNS::Blt, ReaderBaseNS::BneUn, ReaderBaseNS::BgeUn,
    ReaderBaseNS::BgtUn, ReaderBaseNS::BleUn, ReaderBaseNS::BltUn,
    -1,                        // CEE_SWITCH,
